            ...
            <div class="card-body px-4 pb-2">
                <form action="{{url('/supplier/store')}}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control p-2 @error('no_telp_supplier') is-invalid @enderror" minlength="10" min="10" value="{{old('no_telp_supplier')}}" id="no_telp_supplier" name="no_telp_supplier" placeholder="masukkan no telp..">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control p-2 @error('alamat_supplier') is-invalid @enderror" name="alamat_supplier" id="alamat_supplier" placeholder="alamat_supplier.." rows="3">{{ old('alamat_supplier') }}</textarea>

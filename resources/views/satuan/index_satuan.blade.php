      ...
      <div class="card my-4">
        ...
        <div class="card-body px-0 pb-2">
          ...
          <div style="height:40px; black" class="d-flex">
            <form action="{{url('satuan')}}" method="GET" class="ms-md-auto pe-md-3 d-flex align-items-center">
              <div class="input-group input-group-outline">
                <label class="form-label">Type here...</label>
                <input type="text" value="{{Request::get('key')}}" name="keysatuan" class="form-control">
              </div>
